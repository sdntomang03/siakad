                ...
                <table class="w-full text-sm text-left text-slate-500 dark:text-slate-400">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-[10px] font-bold bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-300 mb-1 uppercase tracking-wider">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center">
                                <div class="inline-flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm text-slate-400">Klik "Buat Penilaian Baru" untuk mulai menginput
                                        nilai siswa.</p>
                                </div>
                            </td>
                        </tr>
