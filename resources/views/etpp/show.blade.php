<x-guard-layout>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- Kondisi jika NIP diketik di URL tapi tidak ada di database --}}
            @if($nip && !$employee)
            <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            class="w-20 h-20 bg-indigo-200 text-indigo-700 rounded-full mx-auto flex items-center justify-center text-2xl font-black mb-3 uppercase">
                            {{ substr($employee->nama_lengkap, 0, 1) }}
                        </div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">{{ $employee->nama_lengkap }}</h3>
                        <p class="text-sm text-slate-500 font-mono mt-1">{{ $employee->nip ?? '-' }}</p>
                        <span
                ...
                {{-- Kolom Kanan: Rincian e-TPP --}}
                <div class="md:col-span-2 space-y-6">
                    <div
                        class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-bold text-slate-800 dark:text-white">Rincian e-TPP (Mockup)</h3>
                            <span
                                class="px-3 py-1 bg-emerald-100 text-emerald-800 border border-emerald-200 rounded-lg text-xs font-bold uppercase">Valid</span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div
                                ...
                                <span class="block text-xs font-bold text-slate-500 uppercase mb-1">Skor
                                    Kehadiran</span>
                                <span class="text-2xl font-black text-indigo-600 dark:text-indigo-400">100%</span>
                            </div>
                            <div
                                class="p-4 rounded-xl border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
                        ...
                        <div class="border-t border-slate-200 dark:border-slate-700 pt-6 space-y-3">
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-bold text-slate-600 dark:text-slate-400">Besaran Dasar</span>
                                <span class="text-sm font-semibold text-slate-800 dark:text-slate-200">Rp
                                    2.000.000</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-bold text-rose-500">Pajak PPh 21</span>
                                <span class="text-sm font-semibold text-rose-500">- Rp 100.000</span>
                            </div>
                            <div
                                class="flex justify-between items-center mt-4 pt-4 border-t border-dashed border-slate-300 dark:border-slate-600">
                                <span class="text-base font-black text-slate-800 dark:text-white">Penerimaan
                                    Bersih</span>
