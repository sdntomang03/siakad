<x-app-layout>
    ...
    <div class="py-4 sm:py-8 pb-28 lg:pb-8" x-data="{
     ...
     async next() {
    // 1. Ambil data dari form saat ini
    const formElement = document.getElementById('studentForm');
    const formData = new FormData(formElement);

    try {
        // 2. Kirim data secara asynchronous ke server
        ...
        if (response.ok) {
        // 3. Jika berhasil simpan, pindah ke tab selanjutnya
        if(this.currentIndex < this.tabsList.length - 1) { this.tab=this.tabsList[this.currentIndex + 1];
            window.scrollTo({ top: 0, behavior: 'smooth' }); } } else { alert('Gagal menyimpan otomatis. Periksa kembali
            inputan Anda.'); } } catch (error) { console.error('Terjadi kesalahan:', error); } }, prev() {
                            ...
                            <div
                                ...
                                <div class="p-6 sm:p-8 flex-1">
                                        ...
                                        <div x-data="{ photoName: null, photoPreview: null }"
                                            ...
                                            <div class="flex-1 text-center sm:text-left w-full">
                                                ...
                                                <p class="text-xs text-slate-500 dark:text-slate-400 mb-3">Gunakan foto
                                                    dengan rasio 4x6 (potret, latar bebas), format JPG/PNG/WebP maks.
                                                    2MB.
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                            ...
                                            <div>
                                                ...
                                                <select name="agama"
                                                    class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-slate-900 dark:border-slate-600 dark:text-white">
                                                    <option value="">-- Pilih --</option>
                                                    @php $agamaLama = old('agama', $student->student->agama ?? '');
                                                    @endphp
                                    ...
                                    <div x-show="tab === 'alamat'" x-transition:enter="transition ease-out duration-300"
                                        ...
                                        x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                                        <div class="mb-6 pb-4 border-b border-slate-100 dark:border-slate-700">
                                            <h3 class="text-xl font-bold text-slate-800 dark:text-white">Alamat &
                                                Domisili
                                                Siswa</h3>
                                        </div>
                                        <div class="grid grid-cols-1 sm:grid-cols-6 gap-y-6 gap-x-4">
                                            ...
                                            <div class="sm:col-span-2">
                                                ...
                                                <select x-model="selectedCityId"
                                                    @change="fetchDistricts(selectedCityId)"
                                                ...
                                                <div>
                                                    ...
                                                    <select name="jenis_tinggal"
                                                        ...
                                                        <option value="Bersama Wali" {{
                                                            $jenisTinggalLama=='Bersama Wali' ? 'selected' : '' }}>
                                                            Bersama Wali</option>
                                                        <option value="Kost" {{ $jenisTinggalLama=='Kost' ? 'selected'
                                                            : '' }}>
                                                            Kost</option>
                                                        <option value="Asrama" {{ $jenisTinggalLama=='Asrama'
                                                            ? 'selected' : '' }}>
                                                            Asrama</option>
                                                        <option value="Panti Asuhan" {{
                                                            $jenisTinggalLama=='Panti Asuhan' ? 'selected' : '' }}>
                                                            Panti Asuhan</option>
                                                    </select>
                                                </div>
                                                <div>
                                                    ...
                                                    <select name="alat_transportasi"
                                                        ...
                                                        <option value="Jalan Kaki" {{
                                                            $alatTransportasiLama=='Jalan Kaki' ? 'selected' : '' }}>
                                                            Jalan Kaki</option>
                                                        <option value="Sepeda" {{ $alatTransportasiLama=='Sepeda'
                                                            ? 'selected' : '' }}>Sepeda</option>
                                                        <option value="Motor" {{ $alatTransportasiLama=='Motor'
                                                            ? 'selected' : '' }}>Motor</option>
                                                        <option value="Mobil" {{ $alatTransportasiLama=='Mobil'
                                                            ? 'selected' : '' }}>Mobil</option>
                                                ...
                                                <div>
                                                    ...
                                                    <select name="jarak_ke_sekolah_km"
                                                        ...
                                                        <option value="5-10 KM" {{ $jarakLama=='5-10 KM' ? 'selected'
                                                            : '' }}>5-10 KM</option>
                                                        <option value="Lebih dari 10 KM" {{
                                                            $jarakLama=='Lebih dari 10 KM' ? 'selected' : '' }}>Lebih
                                                            dari 10 KM</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    {{-- 3. FORM KELUARGA --}}
                                    <div x-show="tab === 'keluarga'"
                                        x-transition:enter="transition ease-out duration-300"
                                        x-transition:enter-start="opacity-0 translate-y-2"
                                        x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                                        @php
                                        $agamaOptions = ['Islam', 'Kristen', 'Katholik', 'Hindu', 'Buddha',
                                        'Khonghucu'];
                                        ...
                                        $pendidikanOptions = ['Tidak tamat', 'SD/MI', 'SMP/MTs', 'SMA/SMK/MA', 'S1',
                                        'S2',
                                        'S3'];
                                        $pendidikanAyahLama = old('pendidikan_ayah',
                                        $student->student->family->pendidikan_ayah ?? '');
                                        $pendidikanIbuLama = old('pendidikan_ibu',
                                        $student->student->family->pendidikan_ibu
                                        ?? '');
                                        ...
                                        <div class="space-y-8">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <h4 class="font-bold text-blue-800 dark:text-blue-400">Data Ayah
                                                        Kandung
                                                    </h4>
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="agama_ayah"
                                                            ...
                                                            <option value="{{ $opt }}" {{ $agamaAyahLama==$opt
                                                                ? 'selected' : '' }}>{{ $opt }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="absolute left-0 top-0 bottom-0 w-1 bg-pink-400 rounded-l-2xl">
                                                </div>
                                                <div
                                                    class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2">
                                                    <h4 class="font-bold text-pink-800 dark:text-pink-400">Data Ibu
                                                        Kandung
                                                    </h4>
                                                    <div class="flex items-center gap-2">
                                                        <span class="text-xs font-bold text-slate-500">Status:</span>
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="agama_ibu"
                                                            ...
                                                            <option value="">-- Pilih --</option>
                                                            @foreach ($agamaOptions as $opt)
                                                            <option value="{{ $opt }}" {{ $agamaIbuLama==$opt
                                                                ? 'selected' : '' }}>{{ $opt }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="absolute left-0 top-0 bottom-0 w-1 bg-slate-400 rounded-l-2xl">
                                                </div>
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="agama_wali"
                                                            ...
                                                            <option value="">-- Pilih --</option>
                                                            @foreach ($agamaOptions as $opt)
                                                            <option value="{{ $opt }}" {{ $agamaWaliLama==$opt
                                                                ? 'selected' : '' }}>{{ $opt }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div x-show="tab === 'finansial'"
                                        ...
                                        <div class="max-w-3xl">
                                            <div
                                                ...
                                                <div
                                                    class="flex items-center pt-4 border-t border-slate-200 dark:border-slate-700">
                                                    <input type="checkbox" name="penerima_bantuan_lain"
                                                        id="bantuan_lain" value="1" {{ old('penerima_bantuan_lain',
                                    ...
                                    {{-- 5. FORM KESEHATAN --}}
                                    <div x-show="tab === 'kesehatan'"
                                        x-transition:enter="transition ease-out duration-300"
                                        x-transition:enter-start="opacity-0 translate-y-2"
                                        x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                                        <div class="mb-6 pb-4 border-b border-slate-100 dark:border-slate-700">
                                            <h3 class="text-xl font-bold text-slate-800 dark:text-white">Data Kesehatan
                                            </h3>
                                        </div>
                                            ...
                                            <div class="sm:col-span-2">
                                                ...
                                                <select name="kebutuhan_khusus"
                                                    ...
                                                    <option value="Grahita Sedang" {{
                                                        $kebutuhanKhususLama=='Grahita Sedang' ? 'selected' : '' }}>
                                                        Grahita Sedang</option>
                                                    <option value="Grahita Ringan" {{
                                                        $kebutuhanKhususLama=='Grahita Ringan' ? 'selected' : '' }}>
                                                    ...
                                                    <option value="Laras" {{ $kebutuhanKhususLama=='Laras' ? 'selected'
                                                        : '' }}>
                                                        Laras</option>
                                                    <option value="Wicara" {{ $kebutuhanKhususLama=='Wicara'
                                                        ? 'selected' : '' }}>
                                                        Wicara</option>
                                                    ...
                                                    <option value="Lainnya" {{ $kebutuhanKhususLama=='Lainnya'
                                                        ? 'selected' : '' }}>
                                                        Lainnya</option>
                                                </select>
                                            </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <button type="button" x-show="currentIndex < tabsList.length - 1"
                                            @click="next()"
