                                    ...
                                    <div class="space-y-8">
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="date" name="tanggal_lahir_ayah"
                                                        value="{{ old('tanggal_lahir_ayah', $student->student?->family?->tanggal_lahir_ayah ? \Carbon\Carbon::parse($student->student->family->tanggal_lahir_ayah)->format('Y-m-d') : '') }}"
                                                        class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-slate-900 dark:border-slate-600 dark:text-white">
                                                    <div>
                                                        <label
                                            ...
                                            <div x-show="bersamaOrtu === 'tidak'"
                                                ...
                                                <div
                                                    class="absolute left-0 top-0 bottom-0 w-1 bg-amber-500 rounded-l-2xl">
                                                </div>
                                                <h4
